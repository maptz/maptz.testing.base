...
namespace Maptz.Testing.Analyzers
{
    ...
    /// </summary>
    public abstract partial class DiagnosticsContextBase
    {
       ...
       protected  Diagnostic[] GetSortedDiagnostics(string[] sources, string language, DiagnosticAnalyzer analyzer)
        {
